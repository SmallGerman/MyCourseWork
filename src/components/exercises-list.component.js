                ...
                <section className="service">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-xl-4 col-lg-6">
                                <div className="service-info">
                                    <img src="files/imgs/fitness-service/abt.jpg" alt="fitness service">
                                        ...
                                        <p className="service-info__who">
                                            для жінок і для особливих чоловіків
                                        </p>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-6">
                            ...
                            <div className="col-xl-4 col-lg-6">
                                <div className="service-info">
                                    <img src="files/imgs/fitness-service/box.jpg" alt="fitness service">
                            ...
                            <div className="col-xl-4 col-lg-6">
                                <div className="service-info">
                                    <img src="files/imgs/fitness-service/ofp.jpg" alt="fitness service">
                                        ...
                                        <p className="service-info__who">
                                            для жінок і особливих чоловіків
                                        </p>
                                </div>
                            </div>
